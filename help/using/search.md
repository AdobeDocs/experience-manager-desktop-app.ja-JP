---
title: '[!DNL Experience Manager] デスクトップアプリでのアセットの参照、検索、プレビュー'
description: ' [!DNL Adobe Experience Manager]  デスクトップアプリケーションでアセットを参照、検索、プレビューします。'
feature: Desktop App
...
>* [デスクトップアプリの使用](/help/using/using-desktop-app.md)
